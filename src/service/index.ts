...
const main = async () => {
  ...
  await cloudwatchLogs
    ...
    const output = await exec(`docker run --mount 'type=bind,src=/home/ubuntu/ec2-audiowmark-test/data,dst=/data' --rm -i audiowmark add test.wav test-out.wav 0123456789abcdef0011223344556677`);
